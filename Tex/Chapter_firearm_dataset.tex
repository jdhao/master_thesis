...
\begin{figure}[t]
	...
	\bicaption[枪支数据库打分数据的偏差统计信息]{枪支数据库打分数据的偏差统计信息。\textbf{左}：总体的偏差信息；\textbf{右}: 个人的偏差信息}{The deviation statistics of the Firearm dataset. \textbf{Left}: overall deviation; \textbf{Right}: personal deviation}
...
\begin{figure}[t!]
	...
	\bicaption{Firearm14k 与其他数据库图片尺寸比值的概率分布}{The probability distribution of image size ratios in Firearm14k and other dataset}
